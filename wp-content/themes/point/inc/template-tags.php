...
if ( ! function_exists( 'point_post_navigation' ) ) :
	...
	function point_post_navigation() {
		...
		<nav class="navigation posts-navigation" role="navigation">
			<!--Start Pagination-->
			<?php
			$point_nav_type = get_theme_mod( 'point_pagination_type' );
			if ( ! empty( $point_nav_type ) ) {
				...
				?>
				<h2 class="screen-reader-text"><?php esc_html_e( 'Posts navigation', 'point' ); ?></h2>
...
function point_categorized_blog() {
	$all_the_cool_cats = get_transient( 'point_categories' );
