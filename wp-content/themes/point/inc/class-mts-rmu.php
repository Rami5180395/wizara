...
class MTS_RMU {
	...
	private function __construct( $config = array() ) {
		$config_defaults = array(
			...
			'notice_install'       => sprintf( __( 'The new %1$s plugin will help you rank better in the search results.', 'point' ), '<a href="https://mythemeshop.com/plugins/wordpress-seo/?utm_source=SEO+Meta+Box&utm_medium=Link+CPC&utm_content=Rank+Math+SEO+LP&utm_campaign=UserBackend" target="_blank">Rank Math SEO</a>' ) . ' @CTA',
			/* Translators: %s is CTA, e.g. "Try it now!" */
			'notice_activate'      => sprintf( __( 'The %1$s plugin is installed but not activated.', 'point' ), '<a href="https://mythemeshop.com/plugins/wordpress-seo/?utm_source=SEO+Meta+Box&utm_medium=Link+CPC&utm_content=Rank+Math+SEO+LP&utm_campaign=UserBackend" target="_blank">Rank Math SEO</a>' ) . ' @CTA',
	...
	public function dashboard_notice_output() {
		...
		<div class="notice notice-warning" id="rmu_dashboard_notice" style="position:relative;">
			<div class="rmu-dashboard-panel">
				<button class="rmu-dashboard-panel-close notice-dismiss" id="rmu-dashboard-dismiss"><span class="screen-reader-text"><?php echo esc_html( 'Dismiss this notice.', 'point' ); ?></span></button>
